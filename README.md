...
|---------|-------|--------------|-------|
| [`backend-jvm`](services/backend-jvm) | Kotlin 1.9 + Java 17, Gradle, coroutines, JUnit 5 | Ingests supplier-material records from third-party partner APIs; normalizes, deduplicates, and runs the work as asynchronous, scheduled jobs over a distributed pipeline. | 26 |
